...
for(i in c(1,2,3,4,5,6,7,14,30,60,90,120,240,365,730,3*365)){
    ...
    hist(max_datos, prob=T, col='yellowgreen', xlim=c(0, 50), ylim=c(0, 0.2), main=paste('Ajuste GEV datos\nBloque:', i, 'día/s'))
    ...
    legend('topleft', c(paste0('Datos (',length(max_datos),')'),'Ajuste GEV', 'mu_hat'),
           lty=c(1,1,3), lwd=3,
