...
Computá el valor de $z_p$ para las estimaciones del problema anterior 
...
Utilizando la función `ci` del paquete `extRemes`, relizá el mismo gráfico que en el ejercicio 4. pero utilizando los **extremos del intervalo de confianza** en lugar de la varianza del estimador $z_p$
